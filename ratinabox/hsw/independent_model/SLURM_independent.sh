...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --array=0-14  # one task per grid combination (5 percent_task_in_response_values x 1 responsive x 3 pcs)
#SBATCH --mem=8GB
#SBATCH --time=2:00:00
#SBATCH --job-name="IM_job_${SLURM_ARRAY_TASK_ID}"
#SBATCH --output=slurm_out/IM_SLURM_out.%A_%a.out
